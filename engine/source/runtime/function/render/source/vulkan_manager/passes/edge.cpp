...
namespace Pilot
{
    void PEdgePass::initialize(VkRenderPass render_pass, VkImageView input_attachment)
    {
    ...
    void PEdgePass::setupDescriptorSetLayout()
    {
    ...
    void PEdgePass::setupDescriptorSet()
    {
    ...
    void PEdgePass::updateAfterFramebufferRecreate(VkImageView input_attachment)
    {
